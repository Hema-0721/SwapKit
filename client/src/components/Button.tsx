...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 touch-target disabled:opacity-50 disabled:cursor-not-allowed';
  ...
  const variants = {
    ...
    danger: 'bg-danger-800 hover:bg-red-950 text-white focus:ring-danger-800',
